<template>
  <div v-if="!drawerState.open" class="footer p-3">
    <div class="hidden md:block fixed bottom-5 left-1/2" style="transform: translate(-50%);">
        ...
        <li>
          <a href="https://www.facebook.com" target="_blank">
            <svg
              ...
              <path class="text-slate-300 hover:text-white" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
            </svg>
          </a>
        </li>
        <li>
