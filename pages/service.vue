<template>
  <div class="container">
    <section
      ...
      >
      <div class="p-10  padding-nav">
        <div class="rounded shadow-lg w-full  bg-white/75 overflow-auto">
          <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2">Service</div>
...
import backgroundImagePath from '~/assets/service.jpg'
...
export default defineComponent({
  setup() {
    ...
    const containerHeight = computed(() => ( height.value - 160 ) + 'px' );
